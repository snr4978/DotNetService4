...
namespace Kean.Application.Query.Implements
{
    ...
    public sealed class BasicService : IBasicService
    {
        ...
        /*
         * 实现 Kean.Application.Query.Interfaces.IBasicService.GetUserCount(string name, string account, int? role) 方法
         */
        ...
        /*
         * 实现 Kean.Application.Query.Interfaces.IBasicService.GetUserList(string name, string account, int? role, string sort, int? offset, int? limit) 方法
         */
