...
namespace Kean.Application.Command.Implements
{
    ...
    public class AdminService : IAdminService
    {
        ...
        /*
         * 实现 Kean.Application.Command.Interfaces.IAdminService.CreateRole(Role role) 方法
         */
        ...
        /*
         * 实现 Kean.Application.Command.Interfaces.IAdminService.ModifyRole(Role role) 方法
         */
        ...
        /*
         * 实现 Kean.Application.Command.Interfaces.IAdminService.DeleteRole(IEnumerable<int> id) 方法
         */
        ...
        /*
         * 实现 Kean.Application.Command.Interfaces.IAdminService.SetRoleMenuPermission(int id, IEnumerable<int> permission) 方法
         */
        ...
        /*
         * 实现 Kean.Application.Command.Interfaces.IAdminService.CreateUser(User user) 方法
         */
        ...
        /*
         * 实现 Kean.Application.Command.Interfaces.IAdminService.ModifyUser(User user) 方法
         */
        ...
        /*
         * 实现 Kean.Application.Command.Interfaces.IAdminService.DeleteUser(IEnumerable<int> id) 方法
         */
        ...
        /*
         * 实现 Kean.Application.Command.Interfaces.IAdminService.ResetPassword(int id) 方法
         */
